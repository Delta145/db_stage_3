...
-- Общий список кофе
SELECT товар.название, товар.стоимость, товар.вес, кофе.тип, AVG(оценка_кофе.id_оценки) as рэйтинг
FROM кофе
         JOIN товар USING (ID)
...
-- Получить заказ
SELECT товар.название, товар.стоимость, товар.вес, заказ.скидка
